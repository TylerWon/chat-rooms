 ...
 * 
 * On success, returns the number of bytes sent. -1 is returned on error
 */
 ...
 * 
 * On success, returns the number of bytes received and *buf will contain the message. -1 is returned on error and 0 is
