...
/**
 * Deletes the struct pollfd at index i in pollfds. If at least half of pollfds is empty after the removal, halves its
 * size unless this would cause its capacity to be less than FDS_INITIAL_CAPACITY.
 */
